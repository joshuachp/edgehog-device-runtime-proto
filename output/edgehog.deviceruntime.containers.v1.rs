...
pub mod containers_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn stats(
            ...
            tonic::Response<tonic::codec::Streaming<super::StatsStream>>,
            tonic::Status,
        > {
            self.inner
                .ready()
...
pub mod containers_service_server {
    ...
    pub trait ContainersService: std::marker::Send + std::marker::Sync + 'static {
        ...
        type StatsStream: tonic::codegen::tokio_stream::Stream<
                Item = std::result::Result<super::StatsStream, tonic::Status>,
            >
            + std::marker::Send
            + 'static;
        /// Stream container statistics.
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/edgehog.deviceruntime.containers.v1.ContainersService/Get" => {
                    ...
                    > tonic::server::UnaryService<super::GetRequest> for GetSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ContainersService>::get(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/edgehog.deviceruntime.containers.v1.ContainersService/Stats" => {
                    ...
                    for StatsSvc<T> {
                        type Response = super::StatsStream;
